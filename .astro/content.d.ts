...
"callToActionSection": Record<string, {
  id: string;
  body?: string;
  collection: "callToActionSection";
  data: InferEntrySchema<"callToActionSection">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"planSection": Record<string, {
  id: string;
  body?: string;
  collection: "planSection";
  data: InferEntrySchema<"planSection">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
