...
const calculateFontSizes = (base, scale) => {
  ...
  sizes["h1"] = `${rawSizes["h1"] * 1.67}rem`;
  sizes["h1-md"] = `${rawSizes["h1"] * 1.25}rem`; // 75% between h1 and h1-sm
  sizes["h1-sm"] = `${rawSizes["h1"] * 0.9}rem`;

  sizes["h2"] = `${rawSizes["h2"] * 1.41}rem`;
  sizes["h2-md"] = `${rawSizes["h2"] * 1.15}rem`; // 75% between h2 and h2-sm
  sizes["h2-sm"] = `${rawSizes["h2"] * 0.9}rem`;

  sizes["h3"] = `${rawSizes["h3"] * 1.21}rem`;
  sizes["h3-md"] = `${rawSizes["h3"] * 1.05}rem`; // 75% between h3 and h3-sm
  sizes["h3-sm"] = `${rawSizes["h3"] * 0.9}rem`;

  sizes["h4"] = `${rawSizes["h4"] * 0.87}rem`;
  sizes["h4-sm"] = `${rawSizes["h4"] * 0.9}rem`; // No -md in original

  sizes["h5"] = `${rawSizes["h5"] * 0.87}rem`;
  sizes["h5-sm"] = `${rawSizes["h5"] * 0.9}rem`; // No -md in original

  sizes["h6"] = `${rawSizes["h6"] * 0.83}rem`;
  sizes["h6-sm"] = `${rawSizes["h6"] * 0.9}rem`; // No -md in original
